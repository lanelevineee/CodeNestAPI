...
class ConfirmPasswordResetSerializer(Serializer):
    """Serializer for confirming and completing password reset."""
...
class LoggedInUserSerializer(ModelSerializer):
    """Serializer for logged-in user data."""

    class Meta:
        model = User
        fields = ['id', 'email', 'username', 'firstName', 'lastName', 'is_verified', 'date_joined']
